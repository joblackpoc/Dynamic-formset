...
BookFormset = inlineformset_factory(Author, Book, form=BookForm,can_delete=True, extra=0)
...
class BaseAuthorFormset(BaseInlineFormSet):
    ...
    def save(self, commit=True):
        ...
        return result
AuthorsFormset = inlineformset_factory(AuthorContainer, Author, formset=BaseAuthorFormset, form=AuthorForm, extra=0)
